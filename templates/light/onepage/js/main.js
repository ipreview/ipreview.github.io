...
(function() {
  ...
  $(function() {
    var $window, insert, nav, resizeTimer;
    $window = $(window);
    ...
    if ($('audio').length === 0) {
      ...
      setTimeout("$('#loading').animate(			{'opacity': '0'}, 300, function() {$('#loading').hide()}		)", 500);
      setTimeout("$( '.main-content, .content_wrapper' ).animate(			{'opacity': '1'}, 500		)", 500);
    }
    ...
    */
    ...
    if (($('.onepage').length)) {
      ...
      if ($.fn.parallax) {
        ...
        return $('#services').parallax("50%", 0.1);
      }
    }
    /* End of Single page
    */
